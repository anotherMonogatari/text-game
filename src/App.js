    ...
    return <section>
      <div className='class'>
        ...
        <div className='class-container'>
          <div>
            <div className={'player-icon monk'}></div>
            <button onClick={props.classHandler}>Monk</button>
            <p>Can heal himself</p>
          </div>

          <div>
            <div className={'player-icon mage'}></div>
            <button onClick={props.classHandler}>Mage</button>
            <p>Can temporary boost his attack power</p>
          </div> 
          
          <div>
            <div className={'player-icon warrior'}></div>
            <button onClick={props.classHandler}>Warrior</button>
            <p>Can temporary boost his defence</p>
          </div>
        </div>
      </div>
      ...
      <div className='game' style={{textAlign: 'center',
                     display: 'none'}}>
        {(props.you.hp > 0 && props.enemy.hp > 0) && 
        <div>
          <div className='flex'>
            <div className='player'>
              <div className={`player-icon ${props.class}`}></div>
              <p><b>You:</b></p>
              <p>Health:<br></br> <b>{props.you.hp}</b> 
                <span
                  style={(props.you.wound > 0) ? {color: 'red'} : {color: 'green'}}>
                    {(props.you.wound !== 0) && <b>{(props.you.wound > 0) ? -props.you.wound : `+${-props.you.wound}`}</b>}
                </span>
              </p>
            ...
            <div className='player'>
              ...
              <p><b>Enemy:</b></p>
              <p>Health:<br></br> <b>{props.enemy.hp}</b> 
                <span 
              style={{color: 'red'}}>{(props.enemy.wound !== 0) && <b>{-props.enemy.wound}</b>}
                </span>
              </p>
              <p>Armor:<br></br> <b>{props.enemy.armor}</b></p>
              <p>Power:<br></br> <b>{props.enemy.power}</b></p>
            </div>
          </div> 
